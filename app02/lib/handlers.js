...
var debug = util.debuglog('handlers');   // $>  NODE_DEBUG=handlers node index.js
...
handlers.index = function(data, callback) {
    ...
    if(data.method.toUpperCase() == 'GET')  {
        debug('\x1b[32m%s\x1b[0m',"Entered handlers.index");
        ...
        helpers.getTemplate('index', templateData, function(err, str) {
            if (!err && str)  {
                ...
                debug('\x1b[32m%s\x1b[0m',"Add universal templates");
                helpers.addUniversalTemplates(str, templateData, function(err, str) {
                    if (!err && str)  {
                        debug('\x1b[34m%s\x1b[0m', str);
    ...
    if(data.method.toUpperCase() == 'GET')  {
        ...
        if (trimmedAssetName.length > 0)  {
            ...
            helpers.getStaticAsset(trimmedAssetName, function(err, data) {
                if (!err && data) {
                    //  Dertermine the content type - default to plain text
